...
public class Circle extends com.a.Star{
	...
	public void StarA() {
		...
		System.out.println(starA.b);// protected 	Works because package b Class Circle extends package a Class Star.
	...
	public void CircleB() {
		...
		System.out.println(cirB.b);// protected 
		System.out.println(cirB.c);// default 
		System.out.println(cirB.d);// private 
	}
