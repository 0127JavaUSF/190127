...
public class Triangle extends com.b.Circle {
	...
	public void CircleA() {
		...
		System.out.println(cirA.b);// protected breaks because Class package a Circle variable 'b' has a protected access modifier
		System.out.println(cirA.c);// default breaks because Class package a Circle variable 'c' has a default access modifier
	...
	public void StarC() {
	  ...
	  public void TriangleC() { 
		  ...
		  System.out.println(traingleC.d);// private  
	  }
